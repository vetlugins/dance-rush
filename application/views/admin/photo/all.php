        ...
        <div class="box">
            <div class="box-title">
                ...
                <div class="pull-right box-toolbar">
                    <a href="/admin/<?php echo $params['module'] ?>/upload" class="btn btn-xs btn-primary">Загрузить фотографии</a>
...
<div class="modal fade" id="addAlbum" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addPhotoAlbum" class="form-horizontal" role="form">
...
<div class="modal fade" id="editAlbum" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editPhotoAlbum" class="form-horizontal" role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
